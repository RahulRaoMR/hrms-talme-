...
async function sendEmail(to, subject, html, options = {}) {
  ...
  if (shouldUseResendEmail() || !hasEmailCredentials()) {
...
async function sendEmailWithResend(to, subject, html, options = {}) {
...
function sendEmailWithSmtp(to, subject, html, options = {}) {
  return Promise.race([
