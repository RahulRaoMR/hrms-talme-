...
export const createJobOpeningAction = create("jobOpenings");
export const updateJobOpeningAction = update("jobOpenings");
export const deleteJobOpeningAction = remove("jobOpenings");
