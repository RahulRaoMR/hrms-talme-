...
const seedLoaders = {
  ...
  "daily-updates": () => [
    {
      id: "daily-update-seed",
      authorName: "Talme Team",
      authorEmail: "team@talme.ai",
      authorRole: "HR",
      message: "Payroll Processing for April payroll 2026\nDiscussion regarding the salary pay structure to implement in razorpay.\nConfiguring the salary structure according to the New labour code / Payroll engine 2.0 in razorpay.\n\nOther HR Related tasks.",
