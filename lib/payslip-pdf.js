...
const APP_ROOT = path.basename(process.cwd()) === "backend" ? path.dirname(process.cwd()) : process.cwd();
const LOGO_FILE_PATH = path.join(APP_ROOT, "public", "talme-logo-payslip.jpg");
